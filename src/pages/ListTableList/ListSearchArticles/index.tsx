...
interface ListSearchArticlesProps {
  ...
  listTableListAndListSearchArticles: StateType;
  loading: boolean;
}
const ListSearchArticles: FC<ListSearchArticlesProps> = ({
  dispatch,
  listTableListAndListSearchArticles: { list },
  loading,
}) => {
  const [form] = Form.useForm();
  useEffect(() => {
    dispatch({
      type: 'listTableListAndListSearchArticles/fetch',
      payload: {
        count: 5,
      },
    });
  ...
  const fetchMore = () => {
    dispatch({
      type: 'listTableListAndListSearchArticles/appendFetch',
      payload: {
        count: pageSize,
      },
    });
...
export default connect(
  ({
    listTableListAndListSearchArticles,
    loading,
  }: {
    listTableListAndListSearchArticles: StateType;
    ...
    listTableListAndListSearchArticles,
    loading: loading.models.listTableListAndListSearchArticles,
  }),
)(ListSearchArticles);
